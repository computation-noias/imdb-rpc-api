...
func (x *CreateMoviePayload) Reset() {
	*x = CreateMoviePayload{}
	if protoimpl.UnsafeEnabled {
...
func (x *CreateMoviePayload) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreateMoviePayload) ProtoMessage() {}

func (x *CreateMoviePayload) ProtoReflect() protoreflect.Message {
	mi := &file_movie_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CreateMoviePayload.ProtoReflect.Descriptor instead.
func (*CreateMoviePayload) Descriptor() ([]byte, []int) {
	return file_movie_proto_rawDescGZIP(), []int{1}
}

func (x *CreateMoviePayload) GetData() *Movie {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_movie_proto_rawDesc = []byte{
	...
	,
	...
	0x6f, 0x76, 0x69, 0x65, 0x50, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x1a, 0x1a, 0x2e, 0x6d, 0x6f,
...
var file_movie_proto_goTypes = []interface{}{
	...
	(*CreateMoviePayload)(nil),  // 1: movie.CreateMoviePayload
	(*CreateMovieResponse)(nil), // 2: movie.CreateMovieResponse
}
var file_movie_proto_depIdxs = []int32{
	0, // 0: movie.CreateMoviePayload.data:type_name -> movie.Movie
	1, // 1: movie.MovieService.Create:input_type -> movie.CreateMoviePayload
	2, // 2: movie.MovieService.Create:output_type -> movie.CreateMovieResponse
...
func file_movie_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_movie_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CreateMoviePayload); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type MovieServiceClient interface {
	Create(ctx context.Context, in *CreateMoviePayload, opts ...grpc.CallOption) (*CreateMovieResponse, error)
}
...
func (c *movieServiceClient) Create(ctx context.Context, in *CreateMoviePayload, opts ...grpc.CallOption) (*CreateMovieResponse, error) {
...
type MovieServiceServer interface {
	Create(context.Context, *CreateMoviePayload) (*CreateMovieResponse, error)
}
...
func (*UnimplementedMovieServiceServer) Create(context.Context, *CreateMoviePayload) (*CreateMovieResponse, error) {
...
func _MovieService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MovieServiceServer).Create(ctx, req.(*CreateMoviePayload))
	}
